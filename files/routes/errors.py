...
def error_410(e, v):
	...
	return {"error": "410 Request Payload Too Large"}, 410
...
def error_413(e, v):
	...
	return {"error": "413 Image Size Too Large"}, 413
...
def error_418(e, v):
	...
	return {"error": "418 I'm A Teapot"}, 418
...
def error_451(e, v):
	...
	return {"error": "451 Unavailable For Legal Reasons"}, 451
